...
def load_user_list():
    try:
        ...
        print('')
        print(colored('SUCCESS:', 'green'), config.DATA_FILEPATH,
              "sucessfully read and parsed")
        print('')
    except FileNotFoundError:
        print('')
        print(colored('ERROR:', 'red'),
              "No Data File Found: Expected JSON at source", config.DATA_FILEPATH)
        print(colored('NOTE:', 'yellow'),
              "Please check and ensure you put your specified file at the correct file path.")
        print('')
